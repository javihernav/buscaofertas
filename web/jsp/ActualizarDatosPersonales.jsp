...
<html lang="es">
    ...
    <body onload="cargarComboBoxDatos()">
        ...
        %>
                ...
                <div class="row">
                    <div class="form-group col-md-6"><label class="control-label ">Nombres:</label><input autofocus="on" class="form-control "id="txtNombres" type="text" value="<%=vo.getNombre() %>" maxlength="45" placeholder="Introduzca sus nombres " oninput="validarNombres()" required></div>
                ...
                <div class="row">
                    ...
                    %>
                    <div class="form-group col-md-6"><label class="control-label ">Fecha de Nacimiento:</label><input class="form-control "id="txtFechaDeNacimiento" type="date" value="<%= vo.getFechaNacimiento() %>" maxlength="45"  oninput="validarFecha()" required></div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6"><label class="control-label ">Usuario:</label><input class="form-control "id="txtUsuario" type="text" value="<%= vo.getNombreUsuario() %>" maxlength="20" placeholder="Nombre de usuario para su cuenta" oninput="validarNombreUsuario()" required></div>
                ...
                <div class="row">
                    <div class="form-group col-md-6"><label class="control-label ">Password:</label><input class="form-control "id="txtPassword" type="password" value="<%= EncriptacionAES.desencriptar("buscaofertas1234", "1234567890abcdef", vo.getContrasena()) %>" maxlength="20" placeholder="Introduzca su contraseña" oninput="validarPassword()" required></div>
                    <div class="form-group col-md-6"><label class="control-label ">Confirmar Password:</label><input class="form-control "id="txtPasswordConfirmacion" type="password" value="<%= EncriptacionAES.desencriptar("buscaofertas1234", "1234567890abcdef", vo.getContrasena()) %>" maxlength="20" placeholder="Confirme su contraseña"  oninput="validarPassword()" required></div>
                </div>
                <div class="row">
                    &nbsp;
                </div>
