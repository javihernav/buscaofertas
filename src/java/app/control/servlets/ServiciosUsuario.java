 ...
 * @author JAVIER
 */
@WebServlet(name = "ServiciosUsuario", urlPatterns = {"/usus/consultar"}) //urlPatterns = {"/ServiciosUsuario"}
public class ServiciosUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                listaUsuarios = control.consultar();
